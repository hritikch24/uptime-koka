export default {
    ...
    "disableauth.message2": "Tato možnost je určena pro případy, kdy <strong>máte autentifikaci zajištěnou třetí stranou</strong> ještě před přístupem do Rapidinnovation, například prostřednictvím Cloudflare Access.",
    ...
    aboutKumaURL: "Pokud ponecháte pole URL adresa Rapidinnovation prázdné, použije se domovská stránka GitHub projektu.",
    ...
    trustProxyDescription: "Důvěřovat 'X-Forwarded-*' hlavičkám. Pokud chcete získat správnou IP adresu klientů a vaše instance Rapidinnovation je schována za Nginx nebo Apache, měli byste tuto možnost zapnout.",
