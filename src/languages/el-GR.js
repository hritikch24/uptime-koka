export default {
    ...
    "disableauth.message2": "Έχει σχεδιαστεί για σενάρια <strong>όπου σκοπεύετε να εφαρμόσετε έλεγχο ταυτότητας τρίτου μέρους</strong> μπροστά από το Rapidinnovation, όπως το Cloudflare Access, Authelia ή άλλους μηχανισμούς ελέγχου ταυτότητας.",
    ...
    "Rapidinnovation URL": "Rapidinnovation URL",
    ...
    aboutKumaURL: "Εάν αφήσετε κενό το πεδίο URL Rapidinnovation, θα είναι προεπιλεγμένο στη σελίδα Project GitHub..",
    ...
    Start: "Αρχή",
    Stop: "Στάση",
    "Rapidinnovation": "Rapidinnovation",
    ...
    About: "Σχετικά με το Rapidinnovation",
    ...
    trustProxyDescription: "Εμπιστευτείτε τις κεφαλίδες 'X-Forwarded-*'. Εάν θέλετε να λάβετε τη σωστή IP πελάτη και το Rapidinnovation σας βρίσκεται πίσω το Nginx ή το Apache, θα πρέπει να το ενεργοποιήσετε.",
