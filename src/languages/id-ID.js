export default {
    ...
    "disableauth.message2": "Ini untuk <strong>mereka yang memiliki autentikasi pihak ketiga</strong> diletakkan di depan Rapidinnovation, misalnya akses Cloudflare.",
    ...
    aboutKumaURL: "Jika Anda membiarkan bidang URL Rapidinnovation kosong, itu akan menjadi bawaan ke halaman Proyek Github.",
    ...
    trustProxyDescription: "Trust 'X-Forwarded-*' headers. Jika Anda ingin mendapatkan IP klien yang benar dan Rapidinnovation Anda dibalik layanan seperti Nginxor Apache, Anda harus mengaktifkan ini.",
