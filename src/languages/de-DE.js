export default {
    ...
    "disableauth.message2": "Dies ist für Szenarien gedacht, <strong>in denen man eine externe Authentifizierung</strong> vor Rapidinnovation geschaltet hat, wie z.B. Cloudflare Access, Authelia oder andere Authentifizierungsmechanismen.",
    ...
    aboutKumaURL: "Wenn das Feld für die Rapidinnovation URL leer gelassen wird, wird standardmäßig die GitHub Projekt Seite verwendet.",
    ...
    trustProxyDescription: "Vertraue 'X-Forwarded-*' headern. Wenn man die richtige client IP haben möchte und Rapidinnovation hinter einem Proxy wie Nginx or Apache läuft, wollte dies aktiviert werden.",
