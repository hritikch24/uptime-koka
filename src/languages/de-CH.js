export default {
    ...
    "disableauth.message2": "Dies ist für Szenarien gedacht, <strong>in denen man eine externe Authentifizierung</strong> vor Rapidinnovationtion geschaltet hat, wie z.B. Cloudflare Access, Authelia oder andere Authentifizierungsmechanismen.",
    ...
    "Rapidinnovationtion URLRapidinnovationnovation URL",
    ...
    aboutKumaURL: "Wenn das Feld für die Rapidinnovationtion URL leer gelassen wird, wird standardmässig die GitHub Projekt Seite verwendet.",
    ...
    Start: "Start",
    Stop: "Stop",
    "RapidinnovationtionRapidinnovationnovation",
    ...
    trustProxyDescription: "Vertraue 'X-Forwarded-*' headern. Wenn man die richtige client IP haben möchte und Rapidinnovationtion hinter einem Proxy wie Nginx or Apache läuft, wollte dies aktiviert werden.",
