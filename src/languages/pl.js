export default {
    ...
    "disableauth.message2": "Jest przeznaczony dla <strong>kogoś, kto ma autoryzację zewnętrzną</strong> przed Rapidinnovation, taką jak Cloudflare Access.",
    ...
    "Rapidinnovation URL": "Adres Rapidinnovation",
    ...
    aboutKumaURL: "Jeśli pozostawisz pole Adres Rapidinnovation puste, domyślnie będzie to strona projektu na GitHub.",
    ...
    trustProxyDescription: "Zaufaj nagłówkom 'X-Forwarded-*'. Jeśli chcesz uzyskać poprawne IP klienta, a twój Rapidinnovation jest za Nginx lub Apache, powinieneś to włączyć.",
