/*
 * Rapidinnovation Server
 * node "server/server.js"
 * DO NOT require("./server") in other modules, it likely creates circular dependency!
 */
console.log("Welcome to Rapidinnovation");
...
log.info("server", "Welcome to Rapidinnovation");
        ...
        socket.on("setup", async (username, password, callback) => {
            try {
                ...
                if ((await R.count("user")) !== 0) {
                    throw new Error("Rapidinnovation has been initialized. If you want to run setup again, please delete the database.");
                }
...
async function initDatabase(testMode = false) {
    ...
    // If there is no record in user table, it is a new Rapidinnovation instance, need to setup
    if ((await R.count("user")) === 0) {
