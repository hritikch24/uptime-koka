...
"echo" "-e" "====================="
"echo" "-e" "Rapidinnovation Installer"
"echo" "-e" "====================="
...
"echo" "-e" "---------------------------------------"
"echo" "-e" ""
"echo" "-e" "Local - Install Rapidinnovation in your current machine with git, Node.js 14 and pm2"
"echo" "-e" "Docker - Install Rapidinnovation Docker container"
"echo" "-e" ""
if [ "$1" != "" ]; then
  type="$1"
else
